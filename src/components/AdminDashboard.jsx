...
const AdminDashboard = () => {
  ...
  const filteredTasks = tasks.filter((t) => {
    let statusMatch = taskFilters.status
      ? t.status === taskFilters.status
      : true;
    let dueDateMatch = taskFilters.dueDate
      ? t.dueDate.slice(0, 10) === taskFilters.dueDate
      : true;
    let priorityMatch = taskFilters.priority
      ? t.priority === taskFilters.priority
      : true;
            ...
            <section>
              ...
              <div className="charts-container">
                <div className="chart pie-chart">
                  <h4 style={{ color: "#4e73df", fontSize: "20px" }}>
                    Tasks Status
                  </h4>
                ...
                <div className="chart bar-chart">
                  <h4 style={{ color: "#1cc88a", fontSize: "20px" }}>
                    Recent Tasks (Bar Chart)
                  </h4>
                  <BarChart width={600} height={400} data={tasks.slice(-7)}>
